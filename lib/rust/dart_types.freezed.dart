...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CallState_Calling value)?  calling,TResult Function( CallState_Connecting value)?  connecting,TResult Function( CallState_Confirmed value)?  confirmed,TResult Function( CallState_Disconnected value)?  disconnected,TResult Function( CallState_Error value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CallState_Calling value)  calling,required TResult Function( CallState_Connecting value)  connecting,required TResult Function( CallState_Confirmed value)  confirmed,required TResult Function( CallState_Disconnected value)  disconnected,required TResult Function( CallState_Error value)  error,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CallState_Calling value)?  calling,TResult? Function( CallState_Connecting value)?  connecting,TResult? Function( CallState_Confirmed value)?  confirmed,TResult? Function( CallState_Disconnected value)?  disconnected,TResult? Function( CallState_Error value)?  error,}){
final _that = this;
switch (_that) {
case CallState_Calling() when calling != null:
return calling(_that);case CallState_Connecting() when connecting != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  calling,TResult Function()?  connecting,TResult Function()?  confirmed,TResult Function()?  disconnected,TResult Function( String field0)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CallState_Calling() when calling != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  calling,required TResult Function()  connecting,required TResult Function()  confirmed,required TResult Function()  disconnected,required TResult Function( String field0)  error,}) {final _that = this;
switch (_that) {
case CallState_Calling():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  calling,TResult? Function()?  connecting,TResult? Function()?  confirmed,TResult? Function()?  disconnected,TResult? Function( String field0)?  error,}) {final _that = this;
switch (_that) {
case CallState_Calling() when calling != null:
return calling();case CallState_Connecting() when connecting != null:
return connecting();case CallState_Confirmed() when confirmed != null:
