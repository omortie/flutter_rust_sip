...
fn link_libs_unix() {
    ...
    println!("cargo:rustc-link-lib=dylib=pjsip-ua");
    println!("cargo:rustc-link-lib=dylib=pjsip-simple");
    println!("cargo:rustc-link-lib=dylib=pjsip");
    println!("cargo:rustc-link-lib=dylib=pjnath");
    println!("cargo:rustc-link-lib=dylib=pjmedia");
    println!("cargo:rustc-link-lib=dylib=pjmedia-codec");
    println!("cargo:rustc-link-lib=dylib=pjmedia-videodev");
    println!("cargo:rustc-link-lib=dylib=pjmedia-audiodev");
    println!("cargo:rustc-link-lib=dylib=pjlib-util");
    println!("cargo:rustc-link-lib=dylib=pj");

    // Optional codecs if you enabled them
    println!("cargo:rustc-link-lib=dylib=resample");
    println!("cargo:rustc-link-lib=dylib=srtp");
    println!("cargo:rustc-link-lib=dylib=speex");
    println!("cargo:rustc-link-lib=dylib=gsmcodec");
    println!("cargo:rustc-link-lib=dylib=g7221codec");
    println!("cargo:rustc-link-lib=dylib=ilbccodec");
    println!("cargo:rustc-link-lib=dylib=webrtc");
    println!("cargo:rustc-link-lib=dylib=yuv");
