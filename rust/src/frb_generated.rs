...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1711448183;
...
fn wire__crate__api__simple__answer_call_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, crate::core::types::TelephonyError>((move || {
                    let output_ok = crate::api::simple::answer_call(api_call_id)?;
                    Ok(output_ok)
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__simple__answer_call_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__simple__hangup_call_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__simple__hangup_calls_impl(port, ptr, rust_vec_len, data_len),
...
impl flutter_rust_bridge::IntoDart for crate::core::dart_types::CallState {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            crate::core::dart_types::CallState::Incoming => [1.into_dart()].into_dart(),
            crate::core::dart_types::CallState::Calling => [2.into_dart()].into_dart(),
            crate::core::dart_types::CallState::Connecting => [3.into_dart()].into_dart(),
            crate::core::dart_types::CallState::Confirmed => [4.into_dart()].into_dart(),
            crate::core::dart_types::CallState::Disconnected => [5.into_dart()].into_dart(),
